...
# Revision:: $Id: logger.rb,v 1.5.2.4 2004/05/27 14:39:11 nahi Exp $
#
# See Logger for documentation.
#
# ActiveState note: this code is being included as part of the
# Ruby debugger to support users of versions of Ruby released
# before 1.8.2, when the standard logger module was included.
#
...
#
class Logger
  /: (\S+),v (\S+)/ =~ %q$Id: logger.rb,v 1.5.2.4 2004/05/27 14:39:11 nahi Exp $
  ProgName = "#{$1}/#{$2}"
